...
export default function EditEventForm({ name, setIsOpen, onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 my-4 justify-start text-gray-700 mx-2 font-medium">
      <div className={classes.modalGridForm}>
        ...
        <input id="name" name="name" type="text" className={inputStyle} autoComplete="off" value={eventName} onChange={handleChange} required />
      </div>
